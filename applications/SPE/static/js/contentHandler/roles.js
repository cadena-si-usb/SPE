...
$('#rolesIndex').ready(function(){
    ...
    function getInfo(){
        ...
        ajaxHandler.count('roles',options).success(function(res){
            max = res;
    ...
    function getRoles(){
        ajaxHandler.find('roles',options).success(function(res){
