...
$('#membresiasIndex').ready(function(){
    ...
    function getInfo(){
        ...
        ajaxHandler.count('membresias',options).success(function(res){
            max = res;
    ...
    function getMembresias(){
        ajaxHandler.find('membresias',options).success(function(res){
    ...
    function getMoreMembresias(evt){
