...
def Tutor_Industrial_Table(db, T):
    ...
    db.define_table('Tutor_Industrial',
                    ...
                    Field('comfirmado_Por_Empresa', 'integer', label=T('Comfirmado Por Empresa'), default=0,
                          requires=IS_IN_SET([0, 1], zero=None),
                          represent=lambda v, r: 'Aprobado' if v == 1 else 'No Aprobado'),
